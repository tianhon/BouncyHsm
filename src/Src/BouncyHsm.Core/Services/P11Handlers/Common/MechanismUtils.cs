...
internal static class MechanismUtils
{
    ...
    static MechanismUtils()
    {
        originalMechanism = new Dictionary<CKM, MechanismInfo>()
        {
            ...
            {CKM.CKM_CAMELLIA_MAC_GENERAL, new MechanismInfo(CamelliaMinKeySize, CamelliaMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, false, Pkcs11SpecVersion.V2_40) },
