...
internal class CamelliaWrapperSigner : IWrapperSigner
{
    private readonly CKM mechanismType;
    private readonly IMac mac;
    private readonly int? generalParameter;
    private readonly ILogger<CamelliaWrapperSigner> logger;

    public CamelliaWrapperSigner(CKM mechanismType,
        IMac mac,
        int? generalParameter,
        ILogger<CamelliaWrapperSigner> logger)
    {
    ...
    public AuthenticatedSigner IntoSigningSigner(KeyObject keyObject, SecureRandom secureRandom)
    {
        ...
        CamelliaKeyObject secretKey = this.CheckKey(keyObject);
    ...
    private CamelliaKeyObject CheckKey(KeyObject keyObject)
    {
